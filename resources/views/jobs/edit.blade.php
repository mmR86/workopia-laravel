<x-layout>
    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
                ...
                <form
                    ...
                    <x-inputs.text id='title' name='title' label='Job Title' placeholder="SE" :value="old('title', $job->title)" />

                    <x-inputs.text-area id="description" name="description" label="Description" placeholder="We are seeking a skilled SE..." :value="old('description', $job->description)" />

                    <x-inputs.text id='salary' name='salary' label='Annual Salary' placeholder='70000' type='number' :value="old('salary', $job->salary)" />

                    <x-inputs.text-area id="requirements" name="requirements" label="Requirements" placeholder="Bachelor's degree in CS" rows="2" :value="old('requirements', $job->requirements)" />
                    ...
                    <x-inputs.text id='tags' name='tags' label='Tags (comma-separated)' placeholder='development, coding, java...' :value="old('tags', $job->tags)" />
                    ...
                    <x-inputs.text id='zipcode' name='zipcode' label='ZIP code' placeholder='12401' :value="old('zipcode', $job->zipcode)" />
